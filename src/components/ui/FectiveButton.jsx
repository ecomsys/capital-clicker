...
const fectiveButtonVariants = cva(
...
function FectiveButton({
  ...
  return (
    <Comp
      ...
      data-size={size}
      className={cn(fectiveButtonVariants({ variant, size, className }))}
      {...props} />
  );
}

export { FectiveButton, fectiveButtonVariants }

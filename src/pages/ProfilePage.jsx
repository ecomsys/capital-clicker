...
export default function ProfilePage() {
  ...
  return (
    ...
    <div className="eco-container h-[100dvh] h-screen flex flex-col pt-2 sm:pt-4 lg:pt-7.5">
      <AdBanner
        href={adBanner.href}
        title={adBanner.title}
        imageSrc={adBanner.imageSrc}
        className="shrink-0 mb-2 sm:mb-4 lg:mb-5"
      />

      <BackTitle
        title="Профиль"
        onBack={() => navigate(-1)}
        className="shrink-0 py-6"
      />

      {/* Центрированный контент, который занимает всё свободное пространство */}
      <div className="max-w-[46.625rem] mx-auto custom-scroll overflow-y-auto scrollbar-none flex-1 pb-10 w-full flex flex-col gap-3 sm:gap-5">
        {/* Статистика */}
        <div>
        ...
        <div className="mt-6">
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[1rem] sm:text-[1.25rem] font-medium">
                Язык
              </span>
            </div>
      ...
      <div className="shrink-0 max-w-[46.625rem] mx-auto w-full flex flex-col items-center justify-center gap-4 pt-3">       
        <button
      ...
      {/* нижний буфер   */}
      <div className="shrink-0 h-26 sm:h-30 lg:h-42 "></div>
    </div>
  );
}
